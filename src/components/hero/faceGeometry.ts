...
export const path = {
  ...
  /** Farhaan's distinctive modern dark-rimmed glasses */
  glassesL: 'M 64 110 L 100 110 C 104 110, 106 112, 106 116 L 106 134 C 106 138, 104 140, 100 140 L 64 140 C 60 140, 58 138, 58 134 L 58 116 C 58 112, 60 110, 64 110 Z',
  glassesR: 'M 120 110 L 156 110 C 160 110, 162 112, 162 116 L 162 134 C 162 138, 160 140, 156 140 L 120 140 C 116 140, 114 138, 114 134 L 114 116 C 114 112, 116 110, 120 110 Z',
  glassesBridge: 'M 106 118 C 109 116, 111 116, 114 118',
  glassesTempleL: 'M 58 116 L 46 122',
  glassesTempleR: 'M 162 116 L 174 122',
} as const
