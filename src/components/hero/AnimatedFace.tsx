        ...
        >
          {layers ? (
            ...
            >
              ...
              {/* Farhaan's stylish dark glasses */}
              <g fill="none" stroke={INK} strokeWidth={3.2} strokeLinecap="round" strokeLinejoin="round">
                <path d={path.glassesL} />
                <path d={path.glassesR} />
                <path d={path.glassesBridge} strokeWidth={2.8} />
                <path d={path.glassesTempleL} strokeWidth={2.4} />
                <path d={path.glassesTempleR} strokeWidth={2.4} />
              </g>
